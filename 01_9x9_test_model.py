...
t = time.localtime()
model_name = "01_3cv256-3cv128-fc1024-fc1024_v10"
dir_name   = "log/"
pre1_name  = "[recording]"
pre2_name  = "[completed]"
...
"""Load Data"""
print ":::Loading data...",
with open('v10_170713_9x9_dataset.pickle', 'rb') as handle:
    x_tr = pickle.load(handle)
with open('v10_170713_9x9_label.pickle', 'rb') as handle:
...
def model(X, train=False):
    ...
    reshape = tf.reshape(cv, [shape[0], shape[1] * shape[2] * shape[3]])
    fc      = reshape
